    ...
    static boolean playBlackjack() {
        ...
        while (true) {
            ...
            JOptionPane.showMessageDialog(null, "Tus cartas son: \n"
                    + aux1 + "\n"
                    + "Su total es " + manoUsuario.getValordeBlackjack() + "\n\n"
                    + "El concesionario está mostrando el " + manoCrupier.getCarta(0));

            char userAction = JOptionPane.showInputDialog(null, "¿Pulse Continuar (C) o Pararse (P)? ").charAt(0);
            ...
            do {
                ...
                if (opcion != 'C' && opcion != 'P') {
                    JOptionPane.showMessageDialog(null, "Por favor responda C o P:  ");
                }
        ...
        JOptionPane.showMessageDialog(null, "El total del distribuidor es " + manoCrupier.getValordeBlackjack());
        ...
        if (manoCrupier.getValordeBlackjack() == manoUsuario.getValordeBlackjack()) {
            ...
            JOptionPane.showMessageDialog(null, "El concesionario gana, " + manoCrupier.getValordeBlackjack()
                    + " puntos para " + manoUsuario.getValordeBlackjack() + ".");
            return false;
        } else {

            JOptionPane.showMessageDialog(null, "Tu ganas, " + manoUsuario.getValordeBlackjack()
                    + " puntos para " + manoCrupier.getValordeBlackjack() + ".");
            return true;
        }
